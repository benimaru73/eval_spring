    ...
    <div class="container-fluid">
        ...
        <div class="form-elements-wrapper">
            <div class="row">
              ...
              out.print("/payments/edit/" + payment.getId());
            %>" method="post">
                            ...
                            <div class="input-style-1">
                                ...
                                <input type="text" id="description" name="description" value="<%= request.getAttribute("payment") != null ? ((Payment) request.getAttribute("payment")).getDescription() : "" %>" >
                            </div>
